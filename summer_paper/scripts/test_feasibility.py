...
Run:  python summer_paper/scripts/test_feasibility.py
"""
...
CASES = [
    ...
    Params(Lw=0.85, A_over_m=1.0, omega_star=20.0, psi0=np.radians(50.0),
           delta0=np.radians(150.0)),
    Params(omega_star=8.0, phi1=np.radians(5.0), A_over_m=0.2),
