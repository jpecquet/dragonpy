...
from feasibility import Params, REF_LW, STUDY_ELEMENT, cycle_averaged_force, replace
...
DELTA0 = np.pi / 2.0
# Aw/m and omega* deviate from the reference config (REF_AW_OVER_MB, REF_OMEGA_STAR)
...
AW_OVER_MB, OMEGA_STAR, LW = 0.25, 8.0, REF_LW
SIGMA0 = np.pi
...
def main():
    ...
    p0 = Params(gamma0=GAMMA0, psi1=PSI1, delta0=DELTA0, Aw_over_mb=AW_OVER_MB,
    ...
    print(f"worst case: omega*={OMEGA_STAR}, Aw*/m*={AW_OVER_MB}, gamma0=40 deg")
