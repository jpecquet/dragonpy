...
prey across the four x,z = +/-3 quadrants, comparing tilt gains K=2 and K=3
at the baseline fore/hind phase offset (pi).
...
OUT_STEM = "pursuit_k_tau_stationary_trajectories"
